...
// 2023-07-26 15:03:38.041301298 -0700 PDT m=+0.007681005

package cmd

const GITVERSION = `ef4a53c Merge branch 'release' of git.xx.network:elixxir/notifications-bot into project/HavenBeta`
const SEMVER = "3.0.0"
