...
func TestImpl_UpdateNdf(t *testing.T) {
	impl := getNewImpl()
	testNdf, err := ndf.Unmarshal(ExampleNdfJSON)
	if err != nil {
		t.Logf("%+v", err)
	}
